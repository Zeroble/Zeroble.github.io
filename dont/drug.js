...
function run() {
    ...
    for (let obj of objectArray){
        ...
        context.drawImage(obj.image,0,0,747,795,obj.x,obj.y,obj.width,obj.height)
    }
...
function checkCollision(obj,otherObj) {
    if((obj.y<otherObj.y&&obj.y+obj.height>otherObj.y)&&(obj.x<otherObj.x&&obj.x+obj.width>otherObj.x))
        return true
    return false
}